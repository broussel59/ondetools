#' produire graph inidice mensuel
#'
#' @param onde_df dataframe produit avec la fonction d'import des donnees
#' @param code_dpt code du departement cible
#' @param mois_cible code du mois cible
#' @param force_complementaire pour prendre en compte ou pas les complementaires
#'
#' @returns graphique ggplot
#' @export
#'
#' @examples
#' produire_graph_indice_mensuel(onde_df, code_dpt = '59', mois_cible = 5, force_complementaire = FALSE)
#'
